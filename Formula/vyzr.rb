class Vyzr < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.7.1/vyzr-darwin-arm64"
      sha256 "ac72d1f8c3b7bcd114d96c7dd95383a41def8aa5f6d24ba13829ecfefb4452c1"
    end
    on_intel do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.7.1/vyzr-darwin-x64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.7.1/vyzr-linux-x64"
      sha256 "390cb385cc716ee3708107ec58fc8b9219418c43869f97e8ec34237a41fea989"
    end
    on_arm do
      url "https://github.com/cordfuse/vyzr/releases/download/v0.7.1/vyzr-linux-arm64"
